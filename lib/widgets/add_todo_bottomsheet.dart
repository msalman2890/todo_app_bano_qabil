...
class _AddTodoBottomSheetState extends State<AddTodoBottomSheet> {
  ...
  String? _titleValidator(String? value) {
    if (value!.isEmpty) {
      return "Data can not empty";
    } else if (value.length < 3) {
      return "Title should be greater than 3 characters";
    }
    return null;
  }
          ...
          children: [
            ...
            InkWell(
              ...
              child: CircleAvatar(
                ...
                radius: 35,
                foregroundImage:
                    todoImage == null ? null : FileImage(todoImage!),
            ...
            Row(
              children: [
                ...
                IconButton(
                    onPressed: () {}, icon: Image.asset("assets/tag.png")),
                const SizedBox(
                  width: 15,
                ),
                IconButton(
                    ...
                    onPressed: () {
                      ...
                      if (date != null) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Text("Date and time is required"),
